 ...
 * @author Karla
 */
public class InterfazVideotecaBienvenida extends javax.swing.JFrame {

    /**
     * Creates new form InterfazVideoteca
     */
    public InterfazVideotecaBienvenida() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Bienvenido a Videotek");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfazVideotecaBienvenida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfazVideotecaBienvenida().setVisible(true);
            }
        });
    }
